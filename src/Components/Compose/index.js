    ...
    <div className="compose w-100">
      <form className="w-100">
        <div className="form-group m-0 d-flex align-items-center" >
          ...
          <Button variant="outline-none" type="button compose-button" className="btn" onClick={(e) =>{handleAddMessage(e, message); setMessage('')}}>
            <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-cursor d-flex text-dark" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
